...
void LuaBinding::registerCoreClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        ...
        .addStaticProperty("MOUSE_BUTTON_1", [] () -> int { return S_MOUSE_BUTTON_1; })
        .addStaticProperty("MOUSE_BUTTON_2", [] () -> int { return S_MOUSE_BUTTON_2; })
        .addStaticProperty("MOUSE_BUTTON_3", [] () -> int { return S_MOUSE_BUTTON_3; })
        .addStaticProperty("MOUSE_BUTTON_4", [] () -> int { return S_MOUSE_BUTTON_4; })
        .addStaticProperty("MOUSE_BUTTON_5", [] () -> int { return S_MOUSE_BUTTON_5; })
        .addStaticProperty("MOUSE_BUTTON_6", [] () -> int { return S_MOUSE_BUTTON_6; })
        .addStaticProperty("MOUSE_BUTTON_7", [] () -> int { return S_MOUSE_BUTTON_7; })
        .addStaticProperty("MOUSE_BUTTON_8", [] () -> int { return S_MOUSE_BUTTON_8; })
        .addStaticProperty("MOUSE_BUTTON_LAST", [] () -> int { return S_MOUSE_BUTTON_LAST; })
        .addStaticProperty("MOUSE_BUTTON_LEFT", [] () -> int { return S_MOUSE_BUTTON_LEFT; })
        .addStaticProperty("MOUSE_BUTTON_RIGHT", [] () -> int { return S_MOUSE_BUTTON_RIGHT; })
        .addStaticProperty("MOUSE_BUTTON_MIDDLE", [] () -> int { return S_MOUSE_BUTTON_MIDDLE; })
