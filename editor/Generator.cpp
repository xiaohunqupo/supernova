...
void editor::Generator::configure(const std::vector<editor::SceneBuildInfo>& scenes, std::string libName, const std::vector<SceneScriptSource>& scriptFiles, const std::vector<editor::BundleSceneInfo>& bundles, const fs::path& projectPath, const fs::path& projectInternalPath, Scaling scalingMode, TextureStrategy textureStrategy, unsigned int canvasWidth, unsigned int canvasHeight, bool vsyncEnabled){
    const fs::path generatedPath = getGeneratedPath(projectInternalPath);
    ...
    FileUtils::writeIfChanged(platformSourceFile, getPlatformEditorSource(projectPath, vsyncEnabled));
...
std::string editor::Generator::getPlatformEditorHeader() {
    ...
    content += "    virtual void setMouseLocked(bool mouseLocked);\n";
...
std::string editor::Generator::getPlatformEditorSource(const fs::path& projectPath, bool vsyncEnabled) {
    std::string content;
    content += "// This file is auto-generated by Doriax Editor. Do not edit manually.\n\n";
    ...
    content += "    }\n";
    content += "}\n\n";
    content += "void PlatformEditor::setMouseLocked(bool mouseLocked){\n";
    content += "    if (mouseLocked){\n";
    content += "        glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);\n";
    content += "    }else{\n";
    content += "        setShowCursor(doriax::Engine::isShowCursor());\n";
    content += "    }\n";
    content += "}\n\n";
